...
class GAIN():
    ...
    def create_network(self):
        ...
        # self.network_layers, num_cv, self.last_cv, self.dim_fmap, self.mask_layer_name = deeplab_layers, 32, "pool5", 512, "fc8-softmax"
        self.network_layers, num_cv, self.last_cv, self.dim_fmap, self.mask_layer_name = small_deeplab_layers, 17, "pool3", 256, "fc8-softmax"
        ...
        with tf.name_scope("sec") as scope:
            ...
            # SEC: localization cue (generated by Grad-CAM)
            cues = self.build_grad_cam(target=out, fmap=self.last_cv, layer_name="cues")
...
if __name__ == "__main__":
    ...
    if opt.with_crf: SAVER_PATH, PRED_PATH, PROB_PATH = "gain_sec_gcam_crf-saver", "gain_sec_gcam_crf-preds", "gain_sec_gcam_crf-probs"
    else: SAVER_PATH, PRED_PATH, PROB_PATH = "gain_sec_gcam-saver", "gain_sec_gcam-preds", "gain_sec_gcam-probs"
